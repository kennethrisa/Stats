...
$sqlTopPlayer = "SELECT Name, PVPKills as PVPKills FROM playerranksdb2
order by PVPKills desc limit 1 offset 0";

$sqlTopPlayer2 = "SELECT Name, PVPKills as PVPKills FROM playerranksdb2
order by PVPKills desc limit 1 offset 1";

$sqlTopPlayer3 = "SELECT Name, PVPKills as PVPKills FROM playerranksdb2
...
$sqlTopClan = "SELECT `Clan`, SUM(PVPKills) as PVPKills FROM `playerranksdb22` where Clan not like 'None' group by `Clan` order by 2 desc limit 1";
$sqlTopClan2 = "SELECT `Clan`, SUM(PVPKills) as PVPKills FROM `playerranksdb2` where Clan not like 'None' group by `Clan` order by 2 desc limit 1 OFFSET 1";
$sqlTopClan3 = "SELECT `Clan`, SUM(PVPKills) as PVPKills FROM `playerranksdb2` where Clan not like 'None' group by `Clan` order by 2 desc limit 1 OFFSET 2";
...
<h3>
  ...
  <div class="col-lg-12">
      ...
      <?php
  $sql = "SELECT `Clan`, SUM(PVPKills) as PVPKills, SUM(Deaths) as Deaths, SUM(KDR) as KDR  FROM `playerranksdb2` where Clan not like 'None' group by `Clan` order by 2 desc limit 100";
