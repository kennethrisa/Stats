...
$result = $conn_sql_stats_6->query($sqlBoars);
$data = $result->fetch_assoc();
$BoarsKilled =  $data['COUNT(animal)'];

$result = $conn_sql_stats_6->query($sqlBears);
$data = $result->fetch_assoc();
$BearsKilled =  $data['COUNT(animal)'];

$result = $conn_sql_stats_6->query($sqlStags);
$data = $result->fetch_assoc();
$StagsKilled =  $data['COUNT(animal)'];

$result = $conn_sql_stats_6->query($sqlWolves);
$data = $result->fetch_assoc();
$WolvesKilled =  $data['COUNT(animal)'];

$result = $conn_sql_stats_6->query($sqlChicken);
$data = $result->fetch_assoc();
...
$result = $conn_ply_rnk_6->query($sqlTopHeli);
$data = $result->fetch_assoc();
$heliPlayer =  $data['Name'];
$heliTotalKills =  $data['HeliKills'];

$result = $conn_ply_rnk_6->query($sqlTopHeliHits);
$data = $result->fetch_assoc();
$heliHitsName =  $data['Name'];
$heliHitsTotal =  $data['HeliHits'];

$result = $conn_ply_rnk_6->query($sqlTopStructuresBuilt);
$data = $result->fetch_assoc();
$pname =  $data['Name'];
$StructuresBuilt =  $data['StructuresBuilt'];

$result = $conn_ply_rnk_6->query($sqlTopOnline);
$data = $result->fetch_assoc();
...
?>
            ...
            <div class="row start">
            <div class=""><pre><p><?php echo $srv6LastReset ?></p></pre></div><br />
...
$result = $conn_ply_rnk_6->query($sql);
